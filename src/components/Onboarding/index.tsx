...
const Onboarding = () => {
  ...
  const carouselData = [
    ...
    { text: 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Suscipit repellendus a architecto accusantium deserunt ipsam necessitatibus vel iusto facere ', image: example3 },
  ];
  ...
  const renderItem = ({ item }) => (
    <View style={styles.slide}>
      ...
      <View style={styles.buttonContainer}>
        <Boton onPress={handleNext} title='Siguiente' styles={styles.button1} textStyles={styles.button1text} />
        <Boton onPress={handleSkipOnboarding} title='Saltar' styles={styles.button2} textStyles={styles.button2text} />
      </View>
    </View>
  );
